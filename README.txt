ENVIRONMENTAL DRUM MACHINE by Genís Plaja i Roglans, U137453.
Computational Music Creativity, SMC Master, 2020-2021.

"A Python-based drum machine to play JSON-based drum patterns with every day and environmental sounds."

This folder contains all the material to run the Environmental Drum Machine experiment.
